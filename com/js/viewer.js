...
function addNewImageViewer(imageid) {
  $('#'+imageid).addClass('viewer');
  var viewer = new Viewer(document.getElementById(imageid), {navbar: false, tooltip: false, toolbar: false});
}
